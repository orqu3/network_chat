...
public class Controller implements Initializable {
            ...
            new Thread(() -> {
                try {
                    while (true) {
                        ...
                        if (str.startsWith("/")) {
                            if (str.equals("/regok")) {
                                regController.addMessage("Registration completed successfully");
                            }
                            if (str.equals("/regno")) {
                                regController.addMessage("Failed to register user\n" +
                                        "The entered username or nickname is already taken");
                            }
    ...
    private void setTitle(String username) {
        String title = String.format("Chat [ %s ]", username);
        if (username.equals("")) {
            title = "Chat";
        }
